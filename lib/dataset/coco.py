...
from dataset.JointsDataset import JointsDataset, PartsDataset
...
class COCOPartDataset(PartsDataset):
    '''
    "keypoints": {
        0: "nose",
        1: "left_eye",
