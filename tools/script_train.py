...
from core.loss import MultiTaskLosses
from core.trainer import do_train as train
from core.trainer import do_validate as validate
...
def main():
    ...
    criterion = MultiTaskLosses(cfg).cuda()
